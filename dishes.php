...
<html lang="en">
<?php
include("connection/connect.php"); error_reporting(0);
session_start();
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose Menus</a></li>
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >₱<?php echo $product['price']; ?></span>
										  <input class="b-r-1" type="text" name="quantity"   style="margin-left:30px;" value="1" size="2" />
                                          <br><br>
